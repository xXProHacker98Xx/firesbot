...
module.exports = function (client) {
    ...
    client.on("guildMemberAdd", async member => {
      ...
      const welcomeembed = new Discord.MessageEmbed()
        ...
        .setDescription(`**Ciao carissimo e benvenuto tra noi ${member.guild.name}!**
      Hi <@${member.id}>!, leggi e rispetta le regole!`)
        .setImage("https://media.discordapp.net/attachments/883825671888060456/962455124918304789/welcome-image.png?width=997&height=674")
